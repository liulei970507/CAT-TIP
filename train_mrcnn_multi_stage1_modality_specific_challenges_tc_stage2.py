...
from tracker_multi_stage1_modality_specific_challenges_tc_stage2 import *
import numpy as np
    ...
    for i in range(pretrain_opts['n_cycles']):
        ...
        if cur_score > best_score:
            ...
            states = {'layers_v': model.layers_v.state_dict(),
                    ...
                    'guidance1_conv0_12': model.guidance1_conv0_12.state_dict(),
                    'guidance1_conv1_12': model.guidance1_conv1_12.state_dict(),
                    'guidance2_conv0_12': model.guidance2_conv0_12.state_dict(),
                    'guidance2_conv1_12': model.guidance2_conv1_12.state_dict(),
                    'guidance3_conv0_12': model.guidance3_conv0_12.state_dict(),
                    'guidance3_conv1_12': model.guidance3_conv1_12.state_dict()}
...
if __name__ == "__main__":
    ...
    parser.add_argument("-model_path", default ="./models/GTOT_multi_tc_stage2/", help = "model path")
