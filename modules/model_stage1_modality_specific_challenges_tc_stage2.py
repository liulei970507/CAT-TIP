...
class MDNet(nn.Module):
    ...
    def load_model(self, model_path):
        tc = states = torch.load(model_path)
        ...
        self.parallel1_v.load_state_dict(tc['parallel1_v'])
        self.parallel2_v.load_state_dict(tc['parallel2_v'])
        self.parallel3_v.load_state_dict(tc['parallel3_v'])
        self.parallel1_i.load_state_dict(tc['parallel1_i'])
        self.parallel2_i.load_state_dict(tc['parallel2_i'])
        self.parallel3_i.load_state_dict(tc['parallel3_i'])
        # print 'loading training model.'
        self.guidance1_conv0_12.load_state_dict(tc['guidance1_conv0_12'])
        self.guidance1_conv1_12.load_state_dict(tc['guidance1_conv1_12'])
        self.guidance2_conv0_12.load_state_dict(tc['guidance2_conv0_12'])
        self.guidance2_conv1_12.load_state_dict(tc['guidance2_conv1_12'])
        self.guidance3_conv0_12.load_state_dict(tc['guidance3_conv0_12'])
        self.guidance3_conv1_12.load_state_dict(tc['guidance3_conv1_12'])
