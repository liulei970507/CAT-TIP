...
set_type = 'GTOT' # set datasets GTOT or RGBT234.
seq_home = '/data/dataset/'+set_type +'/'
...
if set_type=='GTOT':
    seq_list = os.listdir(os.path.join(seq_home))
    output_path = '/home/liulei/CAT++/data/GTOT_'+challenge_type+'.pkl'
elif set_type == 'RGBT234':
    seq_list = os.listdir(os.path.join(seq_home))
    output_path = '/home/liulei/CAT++/data/RGBT234_'+challenge_type+'.pkl'
