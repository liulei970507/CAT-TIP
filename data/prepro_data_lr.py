...
for set_type in ['GTOT']:
    seq_home = '/DATA/liulei/CAT_2022/data_generation/'+set_type +'_LR/'
    seq_list = os.listdir(seq_home)
    if set_type=='GTOT':
        output_path = './GTOT_LR.pkl'
    elif set_type == 'RGBT210':
        output_path = './RGBT210_LR.pkl'
    elif set_type == 'RGBT234':
        output_path = './RGBT234_LR.pkl'
    elif set_type == 'LasHeR':
        output_path = './LasHeR_TrainingSet_LR.pkl'
