...
for set_type in ['RGBT234']:
    seq_home = '/DATA/liulei/CAT_2022/data_generation/'+set_type +'_EI/'
    seq_list = os.listdir(seq_home)
    if set_type=='GTOT':
        output_path = './GTOT_EI.pkl'
    elif set_type == 'RGBT210':
        output_path = './RGBT210_EI.pkl'
    elif set_type == 'RGBT234':
        output_path = './RGBT234_EI.pkl'
    elif set_type == 'LasHeR':
        output_path = './LasHeR_TrainingSet_EI.pkl'
