...
for set_type in ['RGBT234']:
    seq_home = '/DATA/liulei/CAT_2022/data_generation/'+set_type +'_OCC/'
    seq_list = os.listdir(seq_home)
    if set_type=='GTOT':
        output_path = './GTOT_OCC.pkl'
    elif set_type == 'RGBT210':
        output_path = './RGBT210_OCC.pkl'
    elif set_type == 'RGBT234':
        output_path = './RGBT234_OCC.pkl'
    elif set_type == 'LasHeR':
        output_path = './LasHeR_TrainingSet_OCC.pkl'
