...
from tracker_multi_stage1_modality_specific_challenges_ei import *
import numpy as np
...
'guidance1_conv0_21': model.guidance1_conv0_21.state_dict(),
            'guidance1_conv1_21': model.guidance1_conv1_21.state_dict(),
            'guidance2_conv0_21': model.guidance2_conv0_21.state_dict(),
            'guidance2_conv1_21': model.guidance2_conv1_21.state_dict(),
            'guidance3_conv0_21': model.guidance3_conv0_21.state_dict(),
            'guidance3_conv1_21': model.guidance3_conv1_21.state_dict()}
...
if __name__ == "__main__":
    ...
    parser.add_argument("-model_path", default ="./models/GTOT_multi_ei/", help = "model path")
