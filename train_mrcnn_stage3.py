...
def train_mdnet():
    ...
    if pretrain_opts['set_type'] == 'RGBT234':
        img_home = '/home/DATA/liulei/RGBT234/'  
        data_path = './data/RGBT234_ALL.pkl'
    elif pretrain_opts['set_type'] == 'GTOT':
        img_home = '/home/DATA/liulei/GTOT/'
...
if __name__ == "__main__":
    ...
    parser.add_argument("-model_path", default ="./models/GTOT_multi_cat_stage31_ensemble/", help = "model path")
    ...
    parser.add_argument("-init_model_path", default="/home/user/liulei/cat/models/GTOT_multi/GTOT_multi1011.pth")
    parser.add_argument("-batch_frames", default = 2, type = int)
