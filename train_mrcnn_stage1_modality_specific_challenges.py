...
from tracker_stage1_modality_specific_challenges import *
import numpy as np
...
def train_mdnet():
    ...
    for i in range(pretrain_opts['n_cycles']):
        ...
        if cur_score > best_score:
            ...
            if pretrain_opts['use_gpu']:
                model = model.cpu()
            states = {'parallel1_v': model.parallel1_v.state_dict(),
...
if __name__ == "__main__":
    ...
    parser.add_argument("-set_type", default = 'RGBT234_ILL')
    parser.add_argument("-padding_ratio", default = 5., type =float)
    parser.add_argument("-model_path", default ="/home/liulei/cat/models/RGBT234_ILL.pth", help = "model path")
