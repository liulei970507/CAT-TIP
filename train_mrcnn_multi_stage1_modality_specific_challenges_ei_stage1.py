...
from tracker_multi_stage1_modality_specific_challenges_ei_stage1 import *
import numpy as np
...
if __name__ == "__main__":
    ...
    parser.add_argument("-model_path", default ="./models/GTOT_multi_ill_stage1/", help = "model path")
