...
from tracker_multi_stage1_modality_specific_challenges_tc_stage2_film import *
import numpy as np
...
if __name__ == "__main__":
    ...
    parser.add_argument("-model_path", default ="./models/GTOT_multi_tc_stage2_film/", help = "model path")
    ...
    parser.add_argument("-init_model_path", default="/home/user/liulei/cat/models/GTOT_multi_tc_stage1/GTOT_multi87.pth")
